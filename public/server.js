...
// Health check — Railway polls this; must respond FAST
...
// Ensure public directory exists at runtime (prevents crash on Railway)
...
// SPA fallback — safe: won't crash if index.html is missing
app.get('*', (_req, res) => {
  ...
  if (fs.existsSync(indexPath)) {
    ...
    res.status(200).send(`
      <!DOCTYPE html>
      <html>
        <head><title>Kenya045 Media Hub</title></head>
        <body>
